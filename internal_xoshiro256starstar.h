...
void rand_init_seed(uint64_t a, uint64_t b, uint64_t c, uint64_t d) {
    s[0] = a;
    s[1] = b;
    s[2] = c;
    s[3] = d;
...
void rand_init_seed2(uint64_t a) {
    s[0] = a;
    s[1] = rotl(s[0], 23) ^ s[0];
    uint64_t tmp = (s[1] * 11515253) + 3451;
    tmp = ((tmp * 179) + 31) ^ tmp;
    s[2] = rotl(tmp ^ (uint64_t) rand(), 13);
    tmp = (( (uint64_t) rand() * 19) + 2331) ^ tmp;
    s[3] = s[2] ^ tmp;
}
